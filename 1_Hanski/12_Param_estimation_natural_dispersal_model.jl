# Code that performs the parameter estimation for the Natural dispersal model
...
# Bounds
low_bound = Float64[0,0,-100,-1000]
...
# Threads.@threads 
for i in 1:20
  init_param = [rand(1), rand(1), -rand(1), -rand(1)]
...
# Integrate with estimated parameters
...
filename = path_out*"output_estimation_dist_meanRM_tmin_H_0_2_"*current_date*".csv"
