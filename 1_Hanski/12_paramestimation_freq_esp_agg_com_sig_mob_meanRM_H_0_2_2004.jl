...
# Parameters bounds
low_bound = Float64[0,0,0,-2,-60]
up_bound = Float64[1,1,200,0,0]
...
for i in 1:20
  # init_param = rand(5)*0.01
  # init_param_rel = Float64[0.000474,0.15014,9.5467]
  # init_param[1] = init_param_rel[1]
  # init_param[2] = init_param_rel[2]
  # init_param[3] = init_param_rel[3]
  # init_param[4] = -0.6 + (rand(1)[1]/10)
  # init_param[5] = -12.0 + (rand(1)[1])

  init_param = [0.00021069025532541826, 0.19622471612857578, 6.766191066973541, -0.6697379747677022, -27.283890841172685]
  println("init_param:", init_param)
  result_row = []
  flush(stdout)
