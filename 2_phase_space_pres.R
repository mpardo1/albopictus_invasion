...
df_clim_ESP <-read.csv(paste0(path_pc,"data/InputHanski/ESP/3_rm_alb_ESP_com_0_2_v2.csv"))
...
# Save as Rds to plot
saveRDS(mean_RM, "data/InputHanski/ESP/mean_RM_ESP.Rds")

# Compute an average tmin 
df_tmin_ESP <-read.csv(paste0(path_pc,"data/InputHanski/ESP/min_temp_ESP.csv"))
...
# Save as Rds to plot
saveRDS(min_tmin, "data/InputHanski/ESP/min_tmin_ESP.Rds")
# # wrrite csv
